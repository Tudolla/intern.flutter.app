...
import 'package:intern_app/common/widgets/custom_button.dart';
import 'package:intern_app/common/widgets/custom_textfield.dart';
        ...
        child: Form(
          ...
          child: Column(
            children: [
              ...
              const SizedBox(height: 10),
              CustomButton(text: 'Send to Server', onTap: () {})
            ],
          ),
        )),
      ),
